...
export function DepreciationTable({
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ['depreciation-list', categoryId, year, month, sortBy, sortOrder, page],
    queryFn: () =>
      getDepreciationList({
        categoryId,
        year,
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <SortableHeader field="namaBarang">Nama Barang</SortableHeader>
                  ...
                  <SortableHeader field="nilaiBuku">Nilai Buku</SortableHeader>
            ...
            {data?.meta && data.meta.totalPages > 1 && (
              <div className="mt-4 flex items-center justify-between">
                <p className="text-sm text-gray-500">
                  ...
                  {Math.min(page * pageSize, data.meta.total)} dari {data.meta.total}
                </p>
