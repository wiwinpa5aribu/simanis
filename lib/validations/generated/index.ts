...
export const MutationScalarFieldEnumSchema = z.enum([
  "id",
  "assetId",
  "assetName",
  "fromLocation",
...
export const StockOpnameSessionScalarFieldEnumSchema = z.enum([
  "id",
  "date",
  "location",
  "status",
...
export const AssetOrderByRelevanceFieldEnumSchema = z.enum([
  "id",
  "name",
  "category",
  "location",
...
export const MutationOrderByRelevanceFieldEnumSchema = z.enum([
  "id",
  "assetId",
  "assetName",
  "fromLocation",
